    ...
    return (
        <div className="p-4 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-4">
                        {posts.map((post: Post) => (
                            <div key={post.id} className="bg-white shadow-md rounded-lg p-6">
                                ...
                                <p className="text-black mb-4 leading-relaxed">{post.body}</p>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div>
                    <h2 className="text-2xl font-bold mn-4">
                        Albums
                    </h2>
                    <div className="space-y-4">
                        {albums.map((album: Album) => (
                            <div key={album.id} className="bg-white shadow-md runded-lg p-6">
                                <p className="text-black">{album.title}</p>
                            </div>
                        ))}
                    </div>
                </div>
